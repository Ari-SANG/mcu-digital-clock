...
namespace SerialTimeSync
{
    public sealed class MainForm : Form
    {
        ...
        private readonly Button screenOffButton = new Button();
        ...
        private void BuildInterface()
        {
            ...
            screenOffButton.Text = "立即息屏";
            screenOffButton.Location = new Point(220, 125);
            screenOffButton.Size = new Size(170, 40);
            screenOffButton.Click += ScreenOffButtonClick;
            screenPage.Controls.Add(screenOffButton);

            Label screenNote = AddLabel(screenPage,
                "立即息屏不改变自动息屏设置；按键先唤醒，闹钟响起也会亮屏。",
                18, 172, 590);
        ...
        private async void ScreenOffButtonClick(object sender, EventArgs e)
        {
            await SendFrameAsync(BuildScreenOffFrame(), "立即息屏",
                "显示已关闭，按键可唤醒");
        }
        ...
        private static byte[] BuildScreenOffFrame()
        {
            return new byte[] { 0x07, FrameTail };
        }
        ...
        private void UpdateButtonState()
        {
            ...
            screenOffButton.Enabled = connected && !busy;
        }
